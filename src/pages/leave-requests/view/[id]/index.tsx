...
import { useLeaveRequestFindFirst, useRoqClient } from 'lib/roq';
...
function LeaveRequestViewPage() {
  ...
  const { data, error, isLoading } = useLeaveRequestFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('leave_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/leave-requests/edit/${id}`} passHref legacyBehavior>
                    <Button
