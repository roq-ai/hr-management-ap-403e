  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash your team's potential with HR Management Application - Your ultimate solution for efficient and streamlined human resources processes."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your team's potential with HR Management Application - Your ultimate solution for efficient and streamlined human resources processes.`}
            </Text>
            <Box
