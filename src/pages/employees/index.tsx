  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'organization', 'attendance.count', 'job_position.count', 'leave_request.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('leave_request', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'leave_request',
          cell: ({ row: { original: record } }: any) => record?._count?.leave_request,
        }
      : null,
